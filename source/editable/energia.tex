	...
	\begin{table}[!h]
		...
		\begin{tabular}[c]{@{}l@{}}Estudo sobre as propriedades do fluido\\ dentro do amortecedor e sobre a possibilidade\\ de monitorar essa temperatura\end{tabular} & 29/04 - 19/05 & \begin{tabular}[c]{@{}c@{}}Micaelle,\\ Thialei\end{tabular} & 50\% \\ \hline
		\begin{tabular}[c]{@{}l@{}}Novos testes no acionamento do motor e\\ controle de velocidades\end{tabular} & 30/05 - 03/06 & \begin{tabular}[c]{@{}c@{}}Ana Rafaela,\\ Ludmila\end{tabular} & 0\% \\ \hline
		...
		\begin{tabular}[c]{@{}l@{}}Simulação e definição da temperatura\\ do óleo do amortecedor\end{tabular} & 13/04 - 17/05 & \begin{tabular}[c]{@{}c@{}}Ana Rafaela,\\ Ludmila,\\ Micaelle,\\ Thialei\end{tabular} & 0\% \\ \hline
		\end{tabular}%
		}
	\end{table}
...
\subsection{Dimensionamento do Conjunto Motor/Inversor}
...
\subsection{Ensaios em Laboratório}
	...
	\subsubsection{Ensaios com Simulação de Cargas}
		...
		\subsubsubsection{Gerador de Indução}
		...
		\subsubsubsection{Freio de Prony}
