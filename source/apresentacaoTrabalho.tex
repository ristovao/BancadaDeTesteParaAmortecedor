...
\label{chap:apresentacao}
	...
	\label{sec:apresentacao_organizacao}
		...
		\begin{enumerate}
			...
			\item{\textbf{\nameref{chap:referencial}}: Uma revisão bibliográfica a respeito da literatura sobre o tema do projeto;}
			...
			\item{\textbf{\nameref{chap:consideracoes}}: As considerações finais sobre o ponto de controle II;}
		\end{enumerate}
